...
### 3.2 Out of scope (noted, not changed)

- API group stays `assistant.suanova.io` (design examples use
  `ai.cubestack.io`; changing the group is a breaking convention change, not
  requested).
