...
func (in *AgentTemplateSpec) DeepCopyInto(out *AgentTemplateSpec) {
	*out = *in
	if in.Providers != nil {
		...
		*out = make([]TemplateProviderSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateProviderSpec) DeepCopyInto(out *TemplateProviderSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateProviderSpec.
func (in *TemplateProviderSpec) DeepCopy() *TemplateProviderSpec {
	if in == nil {
		return nil
	}
	out := new(TemplateProviderSpec)
	in.DeepCopyInto(out)
	return out
}
