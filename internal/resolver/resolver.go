...
type ResolvedAgentConfig struct {
	...
	// the union of the platform builtin, the template's allowlist and the
	// instance's own hand-authored rules. The instance adds to it and cannot
	// remove from it, so an empty instance list means "adds nothing". Only
	// enforced under Allowlist policy.
